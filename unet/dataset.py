...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', type=str, default='./data/train/image')
    parser.add_argument('--train_GT_path', type=str, default='./data/train/masks/')
    parser.add_argument('--valid_path', type=str, default='./data/val/image')
    parser.add_argument('--valid_GT_path', type=str, default='./data/val/masks/')
    parser.add_argument('--test_path', type=str, default='./data/test/image')
    parser.add_argument('--test_GT_path', type=str, default='./data/test/masks')
